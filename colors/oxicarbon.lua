...
colorscheme.highlight_all({
  ...
  Pmenu = function(self)
    return { fg = self.Normal.fg, bg = colors.background }
  end,
  ...
  BlinkCmpKindColor = "Label",
  BlinkCmpKindConstant = "Constant",
  BlinkCmpKindConstructor = "@constructor",
  BlinkCmpKind = "Type",
  BlinkCmpKindEnum = "@enum",
  BlinkCmpKindEnumMember = "@enumMember",
  BlinkCmpKindEvent = "Repeat",
  BlinkCmpKindField = "@field",
  BlinkCmpKindFile = "File",
  BlinkCmpKindFolder = "CmpItemKindFileDefault",
  BlinkCmpKindFunction = "Function",
  BlinkCmpKindInterface = "Type",
  BlinkCmpKindKeyword = "Keyword",
  BlinkCmpKindMethod = "CmpItemKindFunctionDefault",
  BlinkCmpKindModule = "Include",
  BlinkCmpKindOperator = "Operator",
  BlinkCmpKindProperty = "@property",
  BlinkCmpKindReference = "StorageClass",
  BlinkCmpKindSnippet = "Boolean",
  BlinkCmpKindStruct = "Structure",
  BlinkCmpKindText = "Comment",
  BlinkCmpKindTypeParameter = "Typedef",
  BlinkCmpKindUnit = "CmpItemKindStructDefault",
  BlinkCmpKindValue = "CmpItemKindConstantDefault",
